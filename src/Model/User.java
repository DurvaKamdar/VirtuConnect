...
public class User {
	...
	//check if the user has a specific liked post or dislike 
	...
	//Sets the user's friends using a list of User objects
	public void setFriends(ArrayList<User> friends) {
		friendsIDs = new ArrayList<>();//initialize the new list 
		for (User u : friends) {
	...
	//checking if other user is a friend or not 
